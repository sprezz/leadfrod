...
STATICFILES_DIRS = (
    os.path.join(PROJECT_ROOT, 'static-local'),
)
...
SECRET_KEY = 'rp6qx2n=1%u^m_j-@2zqs)(q@j#x+fpnu0hv39yq%45ums6xri'
...
MIDDLEWARE_CLASSES = (
    ...
    'rotator.middleware.disableCSRF',
...
WSGI_APPLICATION = 'leadfrod.wsgi.application'
